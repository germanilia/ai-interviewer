...
@candidate_router.post("/candidates", response_model=CandidateResponse, status_code=http_status.HTTP_201_CREATED)
...
@candidate_router.delete("/candidates/{candidate_id}", status_code=http_status.HTTP_204_NO_CONTENT)
